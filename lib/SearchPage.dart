    ...
    return SizedBox(
      ...
      child:  Container(
        ...
        children: [
          ...
          Container(padding: EdgeInsets.fromLTRB(30 * fem, 11.5 * fem, 34 * fem, 1.24 * fem) ,
            width: double.infinity,
            height: 82 * fem,
            decoration: BoxDecoration(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Container(margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 0.7 * fem),
                        width: 40 * fem,
                        height: 40 * fem,
                        child: Image.asset('assets/page-1/images/icon-home.png',
                            width: 40 * fem,
                            height: 40 * fem
                        ),
                      ),
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Container(margin: EdgeInsets.fromLTRB(0 * fem, 0 * fem, 0 * fem, 0.7 * fem),
                        width: 40 * fem,
                        height: 40 * fem,
                        child: Image.asset('assets/page-1/images/vector.png',
                            width: 40 * fem,
                            height: 40 * fem
                        ),
                      ),
